...
/// This notification is posted when a barcode is scanned.
extern NSString *const ADYNotificationBarcodeReceived;
...
/**
 * Disabling this will stop sending scanned barcodes.
...
/**
 * Send a request to refund the given transaction.
 *
 ...
 * to indicate the progress of the refund-request. It can be one of reversed (refunded) or error.
 * This can be used to inform the user of the status of the refund.
 *
 */
- (void)refundTransaction:(ADYTransactionData *)transaction
