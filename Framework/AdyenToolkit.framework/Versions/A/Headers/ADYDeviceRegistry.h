...
/**
 *  Custom protocol name for Bluetooth devices.
 *  By default, it is `com.adyen.bt1`
 */
@property (nonatomic, strong) NSString *accessoryProtocolName;

/**
 *  List of all supported MFi protocol names
 *  Override for customization
 */
@property (nonatomic, strong) NSArray *supportedAccessoryProtocolNames;
